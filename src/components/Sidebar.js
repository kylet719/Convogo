    ...
    return (
        <div className="drawer-side">
                ...
                <ul className="menu p-4 overflow-y-auto w-min bg-base-100 text-base-content">
                  ...
                  <li>
                    <button type="button" className="flex items-center text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
